...
// ── Deteksi: jika ada error validasi dari server, tunjukkan form yang tepat
// Controller harus set session('_auth_mode') = 'register' saat register gagal
const serverMode = '{{ session("_auth_mode", "login") }}';
